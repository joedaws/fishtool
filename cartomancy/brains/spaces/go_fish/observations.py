...
from cartomancy.games.core.events import ExchangeEvent, BookEvent, AskEvent, DrawEvent, FailEvent, SuccessEvent
...
class ObservedOpponentRanks:
    ...
    def update(self, event):
        ...
        Args:
            event: A dataclass from cartomancy.games.core.events
        """
